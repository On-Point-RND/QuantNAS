...
srun singularity exec --bind /home/d.osin/:/home --bind /gpfs/gpfs0/d.osin/data_main:/home/dev/data_main -f --nv quantnas.sif bash -c '
    ...
    python batch_exp.py -v 1e-6 -d entropy_4_esa_noise -g 0 -c entropy_4_noise.yaml &
    python batch_exp.py -v 1e-5 -d entropy_4_esa_noise -g 1 -c entropy_4_noise.yaml &
    python batch_exp.py -v 1e-4 -d entropy_4_esa_noise -g 1 -c entropy_4_noise.yaml &

...
srun singularity exec --bind /home/d.osin/:/home --bind /gpfs/gpfs0/d.osin/data_main:/home/dev/data_main -f --nv quantnas.sif bash -c '
    cd /home/QuanToaster;
    nvidia-smi;
    (sleep 60; python batch_exp.py -v 0 -d entropy_4_8_esa -g 0 -c entropy_4_8.yaml) &
    python batch_exp.py -v 1e-6 -d entropy_4_8_esa -g 0 -c entropy_4_8.yaml &
    python batch_exp.py -v 1e-5 -d entropy_4_8_esa -g 1 -c entropy_4_8.yaml &
